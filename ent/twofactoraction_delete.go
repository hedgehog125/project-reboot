...
func (_d *TwoFactorActionDelete) Where(ps ...predicate.TwoFactorAction) *TwoFactorActionDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *TwoFactorActionDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *TwoFactorActionDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *TwoFactorActionDelete) sqlExec(ctx context.Context) (int, error) {
...
type TwoFactorActionDeleteOne struct {
	_d *TwoFactorActionDelete
}

// Where appends a list predicates to the TwoFactorActionDelete builder.
func (_d *TwoFactorActionDeleteOne) Where(ps ...predicate.TwoFactorAction) *TwoFactorActionDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *TwoFactorActionDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *TwoFactorActionDeleteOne) ExecX(ctx context.Context) {
