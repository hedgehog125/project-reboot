...
const (
	// Label holds the string label denoting the loginalerts type in the database.
	Label = "login_alerts"
	...
	EdgeSession = "session"
	// Table holds the table name of the loginalerts in the database.
	Table = "login_alerts"
...
// Columns holds all SQL columns for loginalerts fields.
var Columns = []string{
	FieldID,
	FieldTime,
	FieldMessengerType,
...
// OrderOption defines the ordering options for the LoginAlerts queries.
