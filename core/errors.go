...
var ErrAuthorizationCodeNotValidYet = common.NewErrorWithCategories("authorization code not valid yet", common.ErrTypeCore)

var ErrWrapperDownload = common.NewErrorWrapper(common.ErrTypeCore, ErrTypeDownload)
